## Required Features
- Execute the 3 Greedy Strategies and Exhaustive Search on the given data.
- Display the results and summary of the program execution.
- JAR file (a way to run the program in a standard environment without modification).
...
- [ ] Team Code Package (Repository/ZIP folder)
  - Source Code Files (`src/knapsnapProblem`)
    - `DynamicProgramming.java` (Part 4 — Dynamic Programming)
...
- User Input
- Accomodation for Different Data Input
